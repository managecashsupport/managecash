...
const salarySchema = new mongoose.Schema({
  ...
  deductions:  { type: Number, default: 0 },      // leave deductions
  netSalary:   { type: Number, required: true },  // baseSalary - deductions
  paidAmount:  { type: Number, default: 0 },
  balance:     { type: Number, required: true },  // netSalary - paidAmount
